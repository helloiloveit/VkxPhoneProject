...
- (void)setDataArray:(NSArray *)contactData{
    DebugLog(@"");
    self.dataArray = contactData;
    [self update];
}
...
- (void)update {
    ...
    [firstNameLabel setText: @"lalala"];
    
    [lastNameLabel setText: (NSString *)@"lalala"];
    
    [firstNameLabel setText: (NSString *)@"lalala"];
