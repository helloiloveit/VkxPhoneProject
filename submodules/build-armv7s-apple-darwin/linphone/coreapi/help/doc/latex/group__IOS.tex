...
\end{DoxyCode}
 ), the application must first refresh sip registration using function \doxyref{linphone\-\_\-core\-\_\-refresh\-\_\-registers()}{p.}{group__proxies_ga7681c93f7a6173bab3157309fdc619e6}; and register a keep-\/alive handler for periodically refreshing the registration. The speudo code below shows how to register a keep alive handler\-: 
\begin{DoxyCode}
